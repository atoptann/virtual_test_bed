...
[Mesh]
  ...
  [fmg]
    ...
    file = '../../meshes/FHR-core-coarse.e'
  []
  [rename_boundaries]
    type = RenameBoundaryGenerator
    input = 'fmg'
    old_boundary = '1 2 4 5 6 7 8'
    new_boundary = 'bed_horizontal_bottom symmetry_bed bed_left
                    bed_horizontal_top OR_horizontal_bottom barrel_wall
                    OR_horizontal_top'
  []
  [merge]
...
[FVBCs]
  ...
  [outer]
    type = FVDirichletBC
    variable = temp_solid
    boundary = 'barrel_wall'
    value = ${fparse 35 + 600.15}
  []
...
[UserObjects]
  ...
  [wall_dist]
    ...
    outer_radius_x = '0.3 0.3 0.6 0.6 0.5 0.5'
    outer_radius_y = '0.0 0.3 0.6 2.1 2.5 3'
    inner_radius_x = '0 0 0.3 0.3'
    inner_radius_y = '0.0 2.1 2.5 3'
  []
[]
...
[Outputs]
  ...
  csv = true
  hide = 'pressure_in pressure_out mass_flow_OR max_vy '
