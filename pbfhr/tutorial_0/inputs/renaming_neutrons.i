...
# ==============================================================================
[GlobalParams]
  library_file = "../steady/cross_sections/2-D_8Gt_multiregions_transient.xml"
...
[Mesh]
  ...
  [mesh_reader]
    ...
    file = 'FHR-core-coarse.e'
  []
  [rename_generator]
    type = RenameBoundaryGenerator
    input = mesh_reader
    old_boundary = '2 10 7 8 5 6 1'
    new_boundary = 'reflector_surface reflector_surface brick_surface top top bottom bottom'
  []
[]
